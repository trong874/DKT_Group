                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-danger font-weight-bold" id="delete_all" data-url="{{ route("groups.destroy_multi") }}">Xóa</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    function showCategory($groups,$module, $parent_id = null)
    {
        foreach ($groups as $key => $item) {
            ...
            if ($item->parent_id == $parent_id) {
                        ...
                        id="master-' . $item->id . '"
                         class="sub_chk-' . $parent_id . ' checkbox_category"
                           onclick="setId(' . $item->id . ')"
                            ...
                            data-id="' . $item->id . '"
                            style="margin-right:10px"><a href="'.route("$module.show",$item->slug).'"   onmousedown="disabledEventPropagation(event)">' . $item->title . '</a>
                ...
                if ($groups[$key]->group->all() != []) {
                    echo ' <ol class="dd-list">';
                    showCategory($groups[$key]->group,$module, $item->id);
                    echo '</ol>';
                }
                echo '</li>';
            }
